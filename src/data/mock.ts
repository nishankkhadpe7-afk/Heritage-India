...
export const places:Place[]=[
 {name:'Saraswathi Mahal Library',location:'Thanjavur',distance:'1.2 km',category:'Knowledge Heritage',duration:'40 min',image:'library'},
 {name:'Traditional Craft Centre',location:'Thanjavur',distance:'2.4 km',category:'Craft Heritage',duration:'45 min',image:'craft'},
 {name:'Schwartz Church',location:'Thanjavur',distance:'1.8 km',category:'Historic Architecture',duration:'30 min',image:'arch'}];
